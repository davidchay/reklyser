...
function bootstrap3_comment_form_fields( $fields ) {
	...
	$fields    = array(
		'author' => '<div class="form-group comment-form-author" <label for="author">' . __( 'Nombre',
		...
		'url'    => '<div class="form-group comment-form-url"><label for="url">' . __( 'Sitio web',
				'understrap' ) . '</label> ' .
...
function bootstrap3_comment_form( $args ) {
    ...
    <label for="comment">' . _x( 'Comentario', 'noun', 'understrap' ) . ( ' <span class="required">*</span>' ) . '</label>
