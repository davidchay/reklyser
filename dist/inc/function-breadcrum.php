...
if ( ! function_exists( 'pietergoosen_breadcrumbs' ) ) :
  ...
  function pietergoosen_breadcrumbs() {
          /* === OPTIONS === */
     $text['home']     = _x( 'Inicio', 'Home', 'pietergoosen' ); // text for the 'Home' link
     $text['category'] = __( 'Archivo por Categoria "%s"', 'pietergoosen' );  // text for a category page
     $text['search']   = __( 'Resultados de la busqueda "%s" Query', 'pietergoosen' ); // text for a search results page
     $text['tag']      = __( 'Etiqueta "%s"', 'pietergoosen' );  // text for a tag page
     $text['author']   = __( 'Publicado por %s', 'pietergoosen' ); // text for an author page
